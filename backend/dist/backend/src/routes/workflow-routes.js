...
router.post('/', (0, error_handler_1.asyncHandler)(async (req, res) => {
    ...
    res.status(201).json((0, error_handler_1.createSuccessResponse)(createdWorkflow, 'Workflow created successfully'));
}));
/**
...
router.post('/:id/duplicate', (0, error_handler_1.asyncHandler)(async (req, res) => {
    ...
    res.status(201).json((0, error_handler_1.createSuccessResponse)(duplicatedWorkflow, 'Workflow duplicated successfully'));
}));
